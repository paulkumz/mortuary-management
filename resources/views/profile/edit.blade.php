...
@section('content')
<div class="row">
  <a class="btn btn-success btn-xs" href="{{ route('profile.body')}}" role="button"><span class="glyphicon glyphicon-list-alt"></span> View body list</a>
</div>
<div class="row">
        ...
        <form class="form-vertical" role="form" method="post" action="{{ route('profile.edit')}}">
         ...
         <hr>
            ...
            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }} col-lg-5">
              ...
              <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Name" value="">
  ...
  <label for="mortuarybill" class="control-label">Mortuary charge</label>         
   <div class="form-group{{ $errors->has('mortuarybill') ? ' has-error' : '' }}">
            ...
            <div class="form-group">
                <button type="submit" class="btn btn-default"><span class="glyphicon glyphicon-save" aria-hidden="true"></span>Update</button>
            </div>
