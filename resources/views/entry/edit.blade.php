...
<div class="row">
  ...
  <div class="panel-heading ">
    <h3 class="panel-title">Edit deceased profile</h3>
  </div>
  ...
  'class'  => 'form-vertical'
         ...
         <hr>
            ...
            <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }} col-lg-5">
              ...
              <input type="text" name="first_name" class="form-control" id="first_name" placeholder="Name" value="{{$entry->first_name}}">
            ...
            <div class="form-group{{ $errors->has('last_name') ? ' has-error' : '' }} col-lg-5">
             ...
             <input type="text" name="last_name" class="form-control" id="last_name" placeholder="Surname" value="{{$entry->last_name}}">
            ...
            <div class="form-group{{ $errors->has('age') ? ' has-error' : '' }}">
              ...
              <input type="text" name="age" class="form-control" id="age" placeholder="Age" value="{{$entry->age}}">
               @if ($errors->has('age'))
            ...
            @endif
             ...
             <label for="dob" class="control-label">Date of birth</label>   
              <input type="date" name="dob" class="form-control" id="dob" placeholder="Date of Birth" value="{{$entry->dob}}">
               @if ($errors->has('dob'))
            ...
            @endif
             ...
             <div class="form-group{{ $errors->has('dod') ? ' has-error' : '' }} col-lg-6">
              ...
              <input type="date" name="dod" class="form-control" id="dod" placeholder="Date of Death" value="{{$entry->dod}}">
               @if ($errors->has('dod'))
            ...
            <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }} col-lg-6">
              ...
              <input type="text" name="sex" class="form-control" id="sex" placeholder="Sex: Male/Female" value="{{$entry->sex}}">
               @if ($errors->has('sex'))
            ...
            <div class="form-group{{ $errors->has('death_id') ? ' has-error' : '' }} col-lg-4">
                ...
                <input type="text" name="death_id" class="form-control" id="death_id" placeholder="ID:ie NB2356GF" value="{{$entry->death_id}}">
            ...
            <div class="form-group{{ $errors->has('kin') ? ' has-error' : '' }}">
              ...
              <input type="text" name="kin" class="form-control" id="kin" placeholder="Next of kin" value="{{$entry->kin}}">
               @if ($errors->has('kin'))
            ...
            @endif
             ...
             <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
              ...
              <input type="text" name="address" class="form-control" id="address" placeholder="Physical address" value="{{$entry->address}}">
         ...
         <div class="form-group{{ $errors->has('medical') ? ' has-error' : '' }}">
              ...
              <input type="text" name="medical" class="form-control" id="medical" placeholder="Medical Cover" value="{{$entry->medical}}">
            ...
            @endif
             ...
             <div class="form-group{{ $errors->has('funeral') ? ' has-error' : '' }}">
              ...
              <input type="text" name="funeral" class="form-control" id="funeral" placeholder="Funeral cover" value="{{$entry->funeral}}">
            ...
            <div class="form-group{{ $errors->has('illness') ? ' has-error' : '' }} col-lg-6">
              ...
              <input type="text" name="illness" class="form-control" id="illness" placeholder="Last known illness" value="{{$entry->illness}}">
            ...
            <div class="form-group{{ $errors->has('duration') ? ' has-error' : '' }} col-lg-5">
             ...
             <input type="text" name="duration" class="form-control" id="duration" placeholder="Duration" value="{{$entry->duration}}">
            ...
            @endif
             ...
             <div class="form-group{{ $errors->has('death_cause') ? ' has-error' : '' }}">
              ...
              <input type="text" name="death_cause" class="form-control" id="death_cause" placeholder="Cause of death" value="{{$entry->death_cause}}">
            ...
            @endif
              ...
              <input type="text" name="medication" class="form-control" id="medication" placeholder="Medication taken" value="{{$entry->medication}}">
            ...
            <textarea type="text" name="post_mortem" class="form-control" rows="3" id="post_mortem" value="{{$entry->post_mortem}}">{{$entry->post_mortem}}</textarea>
  ...
  <div class="form-group{{ $errors->has('hospitalbill') ? ' has-error' : '' }}">
              ...
              <input type="text" name="hospitalbill" class="form-control" id="hospitalbill" placeholder="Amount:$" value="{{$entry->hospitalbill}}">
  ...
  <label for="mortuarybill" class="control-label">Mortuary charge</label>         
   <div class="form-group{{ $errors->has('mortuarybill') ? ' has-error' : '' }}">
              ...
              <input type="text" name="mortuarybill" class="form-control" id="mortuarybill" placeholder="Amount:$" value="{{$entry->mortuarybill}}">
               @if ($errors->has('mortuarybill'))
              <span class="help-block">{{ $errors->first('mortuarybill') }}</span>
            @endif
            </div>

{!!form::submit('Edit',array('class'=>'btn btn-success btn-xs'))!!}
    
   

            
            <p>Only Authorised personell can edit</p>
